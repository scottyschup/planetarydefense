(function() {
  ...
  GameView.prototype.closeIntro = function (callback) {
    ...
    setTimeout(function () {
      ...
      $('.game-board').css("transform", "translate(0, 800px");
      setTimeout(function () {
        callback();
      }.bind(this), 1500);
    }.bind(this), 1000);
  ...
  GameView.prototype.intro = function () {
    $('.body').css("transform", "translate(0, 500px)");
    setTimeout(function () {
      $('header').css("transform", "translate(0, -2000px)");
      setTimeout(function () {
  ...
  GameView.prototype.openEndGame = function () {
    $(".end-game").css("transform", "translate(0, 300px)");
    this.toggleCursor();
