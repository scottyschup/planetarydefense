(function() {
  ...
  Game.prototype.asteroidCheck = function () {
    if (this.asteroids.length < 5 && this.asteroidCount < Game.END) {
      this.addAsteroid();
    }
  };
  ...
  Game.prototype.calculateFinalDeathtoll = function () {
    var asteroidsLeft = Game.END - this.asteroidsCount + this.asteroids.length;
  ...
  Game.prototype.isOver = function () {
    return (this.asteroidCount === Game.END && this.asteroids.length === 0) ||
           !this.ship.active;
  };
