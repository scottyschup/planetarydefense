(function() {
  ...
  MovingObject.prototype.bumpsInto = function (other) {
    var pos1 = this.pos,
        ...
        unVec = this.scaleVector(normalVec, 1 / magnitudeNormalVec),
        utVec = this.tangentVector(unVec),
        unVel1 = this.dotProduct(unVec, vel1),
        unVel2 = this.dotProduct(unVec, vel2),
        utVel1 = this.dotProduct(utVec, vel1),
        utVel2 = this.dotProduct(utVec, vel2),
        newUNVels = this.newUNVels(unVel1, unVel2, mass1, mass2),
        newUNVecs = this.newUNVecs(newUNVels, [utVel1, utVel2], unVec, utVec);
  ...
  MovingObject.prototype.newUNVecs = function (unVels, utVels, unVec, utVec) {
    var newUNVec1 = this.scaleVector(unVec, unVels[0]);
    var newUNVec2 = this.scaleVector(unVec, unVels[1]);
    var newUTVec1 = this.scaleVector(utVec, utVels[0]);
    var newUTVec2 = this.scaleVector(utVec, utVels[1]);
