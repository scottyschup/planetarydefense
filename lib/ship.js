(function() {
  ...
  var Ship = Asteroids.Ship = function(args) {
    ...
    this.img = new Image();
    this.img.src = Ship.IMG_SRC;
  }

  Asteroids.Util.inherits(Ship, Asteroids.MovingObject);

  Ship.IMG_SRC = "imgs/puddlejumper_small.png";
  Ship.IMG_ACCEL_SRC = "imgs/puddlejumper_small_accel.png"
  Ship.SIZE = 20;
  Ship.COLOR = "white";
  ...
  Ship.prototype.fireDrone = function () {
    var drone = new Asteroids.Drone({
      ...
      vel: [
        Math.cos(this.direction) * 4 + this.vel[0],
        Math.sin(this.direction) * 4 + this.vel[1]
      ],
  ...
  Ship.prototype.propel = function (impulse) {
    ...
    this.img.src = Ship.IMG_ACCEL_SRC;
  };
